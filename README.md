...
Total: **12,634** lines of code across **53** files in the top 5 languages.
...
- **Upstream**: <https://github.com/lusingander/stu>
...
- **Stars**: 908 · **Forks**: 32 · **Open issues**: 57 · **Contributors**: 9

## Totals (cumulative)

- **Releases**: 28 · **Merged PRs**: 45 · **Open PRs**: 0 · **Closed issues**: 42 · **Open issues**: 15 · **Commits**: 928
...
Reported by **15** distros on [repology.org](https://repology.org/project/stu). **10** are ✅ on the latest upstream release, **3** are ⚠️ on an older version.
...
_Snapshot: `data/card/260910.yml` · 2026-09-10T20:45:20Z._
